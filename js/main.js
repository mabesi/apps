...
const translations = {
    pt: {
        tagline: "Desenvolvendo soluções gratuitas e open source",
        heroTitle: "Mabesi Apps",
        heroText: "Desenvolvendo aplicativos gratuitos, open source e sem anúncios para facilitar o seu dia a dia. Todos os projetos são mantidos com dedicação e amor pela comunidade.",
        aboutMission: "Nossa Missão",
        aboutMissionText: "Criar ferramentas úteis, gratuitas e acessíveis para todos, sem anúncios ou custos ocultos.",
        aboutOpenSource: "Open Source",
        aboutOpenSourceText: "Todo código é aberto e disponível no GitHub para contribuições da comunidade.",
    ...
    en: {
        tagline: "Developing free and open source solutions",
        heroTitle: "Mabesi Apps",
        heroText: "Developing free, open source, and ad-free applications to make your daily life easier. All projects are maintained with dedication and love for the community.",
        aboutMission: "Our Mission",
        aboutMissionText: "Create useful, free, and accessible tools for everyone, without ads or hidden costs.",
        aboutOpenSource: "Open Source",
        aboutOpenSourceText: "All code is open and available on GitHub for community contributions.",
    ...
    es: {
        tagline: "Desarrollando soluciones gratuitas y de código abierto",
        heroTitle: "Mabesi Apps",
        heroText: "Desarrollando aplicaciones gratuitas, de código abierto y sin anuncios para facilitar tu día a día. Todos los proyectos se mantienen con dedicación y amor por la comunidad.",
        aboutMission: "Nuestra Misión",
        aboutMissionText: "Crear herramientas útiles, gratuitas y accesibles para todos, sin anuncios ni costos ocultos.",
        aboutOpenSource: "Código Abierto",
        aboutOpenSourceText: "Todo el código está abierto y disponible en GitHub para contribuciones de la comunidad.",
